...
const DEFAULT_STATIONERY_ITEMS: StationeryItem[] = [
  ...
  {
    id: 'form_006',
    name: 'Doctor Progress Notes',
    category: 'forms',
    description: 'Daily medical progress notes by treating physician with clinical findings, plan, and orders',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_007',
    name: 'Out-Patient Department (OPD) Assessment',
    category: 'forms',
    description: 'OPD patient assessment form with chief complaints, vitals, examination, diagnosis, and treatment plan',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_008',
    name: 'Day Care Admission & Procedure Record',
    category: 'forms',
    description: 'Day care admission documentation with procedure details, pre/post assessment, and discharge criteria',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_009',
    name: 'Emergency / Casualty Assessment Form',
    category: 'forms',
    description: 'Emergency department triage and assessment form with vitals, GCS, injury/illness details, and disposition',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_010',
    name: 'Multidisciplinary Counselling Form',
    category: 'forms',
    description: 'Multidisciplinary team counselling record with patient/family education, consent, and counsellor details',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_011',
    name: 'Multidisciplinary Daily Counselling Schedule',
    category: 'forms',
    description: 'Daily schedule for multidisciplinary counselling sessions with timings, departments, and responsible staff',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_012',
    name: 'Nursing Initial Assessment Sheet',
    category: 'forms',
    description: 'Nursing initial assessment with vitals, pain scale, fall risk, nutritional screening, and care plan',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_013',
    name: 'Patient & Attender Safety Orientation',
    category: 'forms',
    description: 'Safety orientation checklist for patients and attendants covering fall prevention, fire safety, and infection control',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_014',
    name: 'Pressure Ulcer Risk Assessment Form',
    category: 'forms',
    description: 'Braden Scale-based pressure ulcer risk assessment with skin inspection findings and prevention plan',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_015',
    name: 'Post Procedure Monitoring (Recovery Room)',
    category: 'forms',
    description: 'Recovery room monitoring record with vitals, Aldrete score, pain assessment, and discharge criteria',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
  ...
  {
    id: 'form_016',
    name: 'Post Procedure Observations',
    category: 'forms',
    description: 'Post-procedure observation chart with vitals monitoring, wound site check, and complications tracking',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
